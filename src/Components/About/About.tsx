               ...
               medium of choice, but she has also enjoyed other mediums, such as graphite and oil.
                ...
                <div className='about-paragraph'>
                    ...
                    <div className='instagram-and-button-container'>
                        <Link to={'https://www.instagram.com/Alpenglow_Artistry/?fbclid=IwAR1htKpLfuakX_2R2bzbL5t3CyQuhy42jEUB-vcQPCt_ohDQvw-sGh9myH8'} >
                        ...
                        <div>
                            <Link to={'/contact'} >
                                <button className='homepage-about-button'>Contact Rachel</button>
                            </Link>
                        </div>
                    </div>
                </div>
